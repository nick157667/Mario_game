...
public class Mario1 extends GameObj {
    ...
    public Mario1(int courtWidth, int courtHeight) {
        super(INIT_VEL_X,  //v_x
        		INIT_VEL_Y, //v_y
        		INIT_X,  //pos_x
        		courtHeight - INIT_HEIGHT - GroundTile.SIZE, //pos_y
    ...
    public void move() {
        ...
        GameCourt1.distanceTravelled += v_x;
        
        // Increment Mario's position
        if (direction == Direction.LEFT || GameCourt1.endTile
                || (direction == Direction.RIGHT && pos_x + width < GameCourt1.MAX_MARIO_X)) 
            pos_x += v_x;
        ...
        if (gravityOn) {
        	...
        	pos_y += GameCourt1.MARIO_Y_VELOCITY;
        }
