...
public class Mario2 extends GameObj {
    ...
    public static final int INIT_X = 32;
    ...
    public Mario2(int courtWidth, int courtHeight) {
    ...
    public void move() {
        ...
        GameCourt2.distanceTravelled += v_x;
        
        // Increment Mario's position
        if (direction == Direction.LEFT || GameCourt2.endTile
                || (direction == Direction.RIGHT && pos_x + width < GameCourt2.MAX_MARIO_X)) 
            pos_x += v_x;
        ...
        if (gravityOn) {
        	...
        	pos_y += GameCourt2.MARIO_Y_VELOCITY;
        }
