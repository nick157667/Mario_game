...
public class UnderGroundTile extends GameObj {
    
    public static String img_file = "UndergroundBlock.png";
    ...
    public UnderGroundTile(int courtWidth, int courtHeight, int initX, int initY) {
