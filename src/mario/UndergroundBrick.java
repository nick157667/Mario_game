...
public class UndergroundBrick extends GameObj {
    
    public static String img_file = "UndergroundBrick.png";
    ...
    public UndergroundBrick(int courtWidth, int courtHeight, int initX, int initY) {
